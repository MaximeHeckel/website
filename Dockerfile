...
ADD ./go /go/src/github.com/MaximeHeckel/website/go/
WORKDIR /go/src/github.com/MaximeHeckel/website/go/src/server
...
COPY --from=serverbuilder /go/src/github.com/MaximeHeckel/website/go/src/server/server ./app/
...
COPY --from=appbuilder /app/build/static/media/* ./app/static/media/
WORKDIR /app
